; === filtro ColorBordes ==
; Instrumentacion: accesos a memoria duplicados
; luego, 
;   costo accesos a memoria = tiempo(instrumentado) - tiempo(sin instrumentar)
